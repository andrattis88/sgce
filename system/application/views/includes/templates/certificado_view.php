    ...
    <body>
        <div class="pagina"
            ...
            <div class="corpo"
                ...
                <p><?=$certificado->de_texto_certificado?></p>
            ...
            <div class="linha_validacao"
                ...
                <? if (@$certificado->fl_ativo!='P'): ?>
                    <div style="margin-left: 80px; margin-right:80px;">           
                        <img width="70" height="70" style="border: 2px solid black;" src="<?= base_url() .  'system/application/views/includes/images/certificado/qrcodes/' . $file_name ?>" />       
                        <p>
                            Verifique a autenticidade deste certificado<br/>
                            na URL abaixo ou com o QRCode acima.<br/>
                            <a href="<?=URL_CERTIFICADO.ENDERECO_VALIDACAO.$certificado->de_hash?>"><?=URL_CERTIFICADO.ENDERECO_VALIDACAO.$certificado->de_hash?></a> 
                        </p>
                    <div>
